...
export function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 group">
      ...
      <div className="hidden sm:block opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 glass-panel-dark text-[#F4EBE1] text-[11px] font-semibold tracking-wider px-4 py-2 rounded-sm border border-[#E2D4C3]/50 shadow-2xl whitespace-nowrap">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-15 h-15 bg-gradient-to-tr from-[#128C7E] via-[#25D366] to-[#25D366] text-white rounded-full shadow-[0_10px_35px_rgba(37,211,102,0.4)] hover:shadow-[0_15px_45px_rgba(226,212,195,0.6)] transition-all duration-300 hover:scale-110 focus:outline-none border-2 border-[#E2D4C3]"
